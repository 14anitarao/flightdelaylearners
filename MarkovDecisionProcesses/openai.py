...
class OpenAI_MDPToolbox:
    ...
    def __init__(self, openAI_env_name:str, render:bool=False, s=8, prob=0.8, **kwargs):
        ...
        random.seed(0)
        random_map = generate_random_map(size=s, p=prob)
    
        self.env = gym.make(self.env_name, desc=random_map, **kwargs)
        self.env.reset()
